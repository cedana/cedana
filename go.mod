...
require (
	...
	buf.build/gen/go/cedana/cedana/grpc/go v1.5.1-00000000000000-ed11ebe7f360.2
	buf.build/gen/go/cedana/cedana/protocolbuffers/go v1.36.6-00000000000000-ed11ebe7f360.1
