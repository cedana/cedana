...
require (
	buf.build/gen/go/cedana/cedana-gpu/grpc/go v1.5.1-00000000000000-50541ff86651.2
	buf.build/gen/go/cedana/cedana-gpu/protocolbuffers/go v1.36.6-00000000000000-50541ff86651.1
