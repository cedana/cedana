...
require (
	buf.build/gen/go/cedana/cedana-gpu/grpc/go v1.6.2-00000000000000-ed0d4ecd86f4.1
	buf.build/gen/go/cedana/cedana-gpu/protocolbuffers/go v1.36.11-00000000000000-ed0d4ecd86f4.1
	...
	buf.build/gen/go/cedana/criu/protocolbuffers/go v1.36.11-00000000000000-f68e5e16a168.1
