...
require (
	buf.build/gen/go/cedana/cedana-gpu/grpc/go v1.5.1-00000000000000-10d2ae0afb27.2
	buf.build/gen/go/cedana/cedana-gpu/protocolbuffers/go v1.36.5-00000000000000-10d2ae0afb27.1
