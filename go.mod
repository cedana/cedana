...
require (
	...
	buf.build/gen/go/cedana/cedana/protocolbuffers/go v1.36.10-20251210183443-4d040457b4e7.1
	buf.build/gen/go/cedana/criu/protocolbuffers/go v1.36.10-20251210183443-f6beafc23c40.1
