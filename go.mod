...
require (
	...
	buf.build/gen/go/cedana/cedana/protocolbuffers/go v1.36.10-20251212163808-968643980335.1
	buf.build/gen/go/cedana/criu/protocolbuffers/go v1.36.10-20251212163808-2a2209062269.1
