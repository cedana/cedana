...
require (
	buf.build/gen/go/cedana/cedana-gpu/grpc/go v1.5.1-20250601200946-6dae1cedcaec.2
	buf.build/gen/go/cedana/cedana-gpu/protocolbuffers/go v1.36.6-20250601200946-6dae1cedcaec.1
