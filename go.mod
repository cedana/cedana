...
require (
	...
	buf.build/gen/go/cedana/cedana/grpc/go v1.5.1-00000000000000-be71bfe06915.2
	buf.build/gen/go/cedana/cedana/protocolbuffers/go v1.36.10-00000000000000-be71bfe06915.1
