...
require (
	...
	buf.build/gen/go/cedana/cedana/grpc/go v1.5.1-00000000000000-be4fa58a8d32.1
	buf.build/gen/go/cedana/cedana/protocolbuffers/go v1.35.2-00000000000000-be4fa58a8d32.1
