...
require (
	...
	buf.build/gen/go/cedana/cedana/grpc/go v1.6.2-00000000000000-3be4e00cb255.1
	buf.build/gen/go/cedana/cedana/protocolbuffers/go v1.36.11-00000000000000-3be4e00cb255.1
