...
require (
	...
	buf.build/gen/go/cedana/cedana/grpc/go v1.5.1-00000000000000-8777902dcbcd.2
	buf.build/gen/go/cedana/cedana/protocolbuffers/go v1.36.5-00000000000000-2b25d7d740a3.1
