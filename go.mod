...
require (
	...
	buf.build/gen/go/cedana/cedana/grpc/go v1.5.1-20250304203714-4a13ed25bd19.2
	buf.build/gen/go/cedana/cedana/protocolbuffers/go v1.36.5-20250304203714-4a13ed25bd19.1
	buf.build/gen/go/cedana/criu/protocolbuffers/go v1.36.5-20250304203714-cc1532bafbf6.1
