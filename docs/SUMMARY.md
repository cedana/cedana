...
- [CLI](references/cli/README.md)
  ...
  - [cedana check](references/cli/cedana_check.md)
  ...
  - [cedana dump crun](references/cli/cedana_dump_crun.md)
  ...
  - [cedana dump-vm](references/cli/cedana_dump-vm.md)
  - [cedana exec](references/cli/cedana_exec.md)
  - [cedana features](references/cli/cedana_features.md)
  - [cedana freeze](references/cli/cedana_freeze.md)
  ...
  - [cedana k8s](references/cli/cedana-k8s.md)
  ...
  - [cedana manage crun](references/cli/cedana_manage_crun.md)
  ...
  - [cedana query crun](references/cli/cedana_query_crun.md)
  ...
  - [cedana restore crun](references/cli/cedana_restore_crun.md)
