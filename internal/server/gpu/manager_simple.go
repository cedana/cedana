...
func (m *ManagerSimple) Attach(ctx context.Context, user *syscall.Credential, pid <-chan uint32, env ...string) (string, error) {
...
func (i actionType) String() string {
	return [...]string{"init", "putController", "shutdown"}[i]
}

func (m *ManagerSimple) syncWithDB(ctx context.Context, action action) error {
	typ := action.typ
