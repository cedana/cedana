...
type Manager interface {
	...
	CRIUCallback(lifetime context.Context, jid string, stream int32) *criu.NotifyCallback
}
...
func (ManagerMissing) CRIUCallback(lifetime context.Context, jid string, stream int32) *criu.NotifyCallback {
	return nil
}
