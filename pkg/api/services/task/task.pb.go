...
var file_task_proto_rawDesc = []byte{
	...
	0x4e, 0x2a, 0x37, 0x0a, 0x08, 0x44, 0x75, 0x6d, 0x70, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a,
	...
	0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x32, 0xc8, 0x11, 0x0a, 0x0b, 0x54, 0x61,
	...
	,
	...
	0x6f, 0x72, 0x65, 0x41, 0x74, 0x74, 0x61, 0x63, 0x68, 0x52, 0x65, 0x73, 0x70, 0x28, 0x01, 0x30,
	0x01, 0x12, 0x62, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e,
...
var file_task_proto_depIdxs = []int32{
	...
	67, // 46: cedana.services.task.HealthCheckStats.GPUHealthCheck:type_name -> cedanagpu.HealthCheckResponse
	14, // 47: cedana.services.task.TaskService.Start:input_type -> cedana.services.task.StartArgs
	16, // 48: cedana.services.task.TaskService.Dump:input_type -> cedana.services.task.DumpArgs
	18, // 49: cedana.services.task.TaskService.Restore:input_type -> cedana.services.task.RestoreArgs
	20, // 50: cedana.services.task.TaskService.Query:input_type -> cedana.services.task.QueryArgs
	22, // 51: cedana.services.task.TaskService.ContainerdDump:input_type -> cedana.services.task.ContainerdDumpArgs
	24, // 52: cedana.services.task.TaskService.ContainerdRestore:input_type -> cedana.services.task.ContainerdRestoreArgs
	26, // 53: cedana.services.task.TaskService.ContainerdQuery:input_type -> cedana.services.task.ContainerdQueryArgs
	29, // 54: cedana.services.task.TaskService.ContainerdRootfsDump:input_type -> cedana.services.task.ContainerdRootfsDumpArgs
	31, // 55: cedana.services.task.TaskService.ContainerdRootfsRestore:input_type -> cedana.services.task.ContainerdRootfsRestoreArgs
	33, // 56: cedana.services.task.TaskService.RuncDump:input_type -> cedana.services.task.RuncDumpArgs
	36, // 57: cedana.services.task.TaskService.RuncRestore:input_type -> cedana.services.task.RuncRestoreArgs
	39, // 58: cedana.services.task.TaskService.RuncQuery:input_type -> cedana.services.task.RuncQueryArgs
	42, // 59: cedana.services.task.TaskService.RuncGetPausePid:input_type -> cedana.services.task.RuncGetPausePidArgs
	12, // 60: cedana.services.task.TaskService.CRIORootfsDump:input_type -> cedana.services.task.CRIORootfsDumpArgs
	10, // 61: cedana.services.task.TaskService.CRIOImagePush:input_type -> cedana.services.task.CRIOImagePushArgs
	57, // 62: cedana.services.task.TaskService.StartAttach:input_type -> cedana.services.task.StartAttachArgs
	59, // 63: cedana.services.task.TaskService.RestoreAttach:input_type -> cedana.services.task.RestoreAttachArgs
	45, // 64: cedana.services.task.TaskService.LogStreaming:input_type -> cedana.services.task.LogStreamingResp
	55, // 65: cedana.services.task.TaskService.ProcessStateStreaming:input_type -> cedana.services.task.ProcessStateStreamingArgs
	61, // 66: cedana.services.task.TaskService.DetailedHealthCheck:input_type -> cedana.services.task.DetailedHealthCheckRequest
	16, // 67: cedana.services.task.TaskService.KataDump:input_type -> cedana.services.task.DumpArgs
	18, // 68: cedana.services.task.TaskService.KataRestore:input_type -> cedana.services.task.RestoreArgs
	64, // 69: cedana.services.task.TaskService.GetConfig:input_type -> cedana.services.task.GetConfigRequest
	15, // 70: cedana.services.task.TaskService.Start:output_type -> cedana.services.task.StartResp
	17, // 71: cedana.services.task.TaskService.Dump:output_type -> cedana.services.task.DumpResp
	19, // 72: cedana.services.task.TaskService.Restore:output_type -> cedana.services.task.RestoreResp
	21, // 73: cedana.services.task.TaskService.Query:output_type -> cedana.services.task.QueryResp
	23, // 74: cedana.services.task.TaskService.ContainerdDump:output_type -> cedana.services.task.ContainerdDumpResp
	25, // 75: cedana.services.task.TaskService.ContainerdRestore:output_type -> cedana.services.task.ContainerdRestoreResp
	27, // 76: cedana.services.task.TaskService.ContainerdQuery:output_type -> cedana.services.task.ContainerdQueryResp
	30, // 77: cedana.services.task.TaskService.ContainerdRootfsDump:output_type -> cedana.services.task.ContainerdRootfsDumpResp
	32, // 78: cedana.services.task.TaskService.ContainerdRootfsRestore:output_type -> cedana.services.task.ContainerdRootfsRestoreResp
	34, // 79: cedana.services.task.TaskService.RuncDump:output_type -> cedana.services.task.RuncDumpResp
	37, // 80: cedana.services.task.TaskService.RuncRestore:output_type -> cedana.services.task.RuncRestoreResp
	40, // 81: cedana.services.task.TaskService.RuncQuery:output_type -> cedana.services.task.RuncQueryResp
	43, // 82: cedana.services.task.TaskService.RuncGetPausePid:output_type -> cedana.services.task.RuncGetPausePidResp
	13, // 83: cedana.services.task.TaskService.CRIORootfsDump:output_type -> cedana.services.task.CRIORootfsDumpResp
	11, // 84: cedana.services.task.TaskService.CRIOImagePush:output_type -> cedana.services.task.CRIOImagePushResp
	58, // 85: cedana.services.task.TaskService.StartAttach:output_type -> cedana.services.task.StartAttachResp
	60, // 86: cedana.services.task.TaskService.RestoreAttach:output_type -> cedana.services.task.RestoreAttachResp
	44, // 87: cedana.services.task.TaskService.LogStreaming:output_type -> cedana.services.task.LogStreamingArgs
	46, // 88: cedana.services.task.TaskService.ProcessStateStreaming:output_type -> cedana.services.task.ProcessState
	62, // 89: cedana.services.task.TaskService.DetailedHealthCheck:output_type -> cedana.services.task.DetailedHealthCheckResponse
	17, // 90: cedana.services.task.TaskService.KataDump:output_type -> cedana.services.task.DumpResp
	19, // 91: cedana.services.task.TaskService.KataRestore:output_type -> cedana.services.task.RestoreResp
	65, // 92: cedana.services.task.TaskService.GetConfig:output_type -> cedana.services.task.GetConfigResponse
