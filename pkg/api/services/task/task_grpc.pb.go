...
type TaskServiceClient interface {
	...
	JobRestoreAttach(ctx context.Context, opts ...grpc.CallOption) (TaskService_JobRestoreAttachClient, error)
...
func (c *taskServiceClient) JobDump(ctx context.Context, in *JobDumpArgs, opts ...grpc.CallOption) (*JobDumpResp, error) {
	out := new(JobDumpResp)
	err := c.cc.Invoke(ctx, "/cedana.services.task.TaskService/JobDump", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskServiceClient) JobRestore(ctx context.Context, in *JobRestoreArgs, opts ...grpc.CallOption) (*JobRestoreResp, error) {
	...
	err := c.cc.Invoke(ctx, "/cedana.services.task.TaskService/JobRestore", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskServiceClient) JobRestoreAttach(ctx context.Context, opts ...grpc.CallOption) (TaskService_JobRestoreAttachClient, error) {
	stream, err := c.cc.NewStream(ctx, &TaskService_ServiceDesc.Streams[0], "/cedana.services.task.TaskService/JobRestoreAttach", opts...)
	if err != nil {
		return nil, err
	}
	x := &taskServiceJobRestoreAttachClient{stream}
	return x, nil
}

type TaskService_JobRestoreAttachClient interface {
	Send(*AttachArgs) error
	Recv() (*AttachResp, error)
	grpc.ClientStream
}

type taskServiceJobRestoreAttachClient struct {
	grpc.ClientStream
}

func (x *taskServiceJobRestoreAttachClient) Send(m *AttachArgs) error {
	return x.ClientStream.SendMsg(m)
}

func (x *taskServiceJobRestoreAttachClient) Recv() (*AttachResp, error) {
	m := new(AttachResp)
...
func (c *taskServiceClient) JobQuery(ctx context.Context, in *JobQueryArgs, opts ...grpc.CallOption) (*JobQueryResp, error) {
	...
	err := c.cc.Invoke(ctx, "/cedana.services.task.TaskService/JobQuery", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskServiceClient) StartAttach(ctx context.Context, opts ...grpc.CallOption) (TaskService_StartAttachClient, error) {
	stream, err := c.cc.NewStream(ctx, &TaskService_ServiceDesc.Streams[1], "/cedana.services.task.TaskService/StartAttach", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *taskServiceStartAttachClient) Send(m *AttachArgs) error {
	return x.ClientStream.SendMsg(m)
}

func (x *taskServiceStartAttachClient) Recv() (*AttachResp, error) {
	m := new(AttachResp)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *taskServiceClient) RestoreAttach(ctx context.Context, opts ...grpc.CallOption) (TaskService_RestoreAttachClient, error) {
	stream, err := c.cc.NewStream(ctx, &TaskService_ServiceDesc.Streams[2], "/cedana.services.task.TaskService/RestoreAttach", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *taskServiceRestoreAttachClient) Send(m *AttachArgs) error {
	return x.ClientStream.SendMsg(m)
}

func (x *taskServiceRestoreAttachClient) Recv() (*AttachResp, error) {
	m := new(AttachResp)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *taskServiceClient) Manage(ctx context.Context, in *ManageArgs, opts ...grpc.CallOption) (*ManageResp, error) {
	out := new(ManageResp)
	err := c.cc.Invoke(ctx, "/cedana.services.task.TaskService/Manage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskServiceClient) RuncManage(ctx context.Context, in *RuncManageArgs, opts ...grpc.CallOption) (*RuncManageResp, error) {
	...
	err := c.cc.Invoke(ctx, "/cedana.services.task.TaskService/RuncManage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskServiceClient) LogStreaming(ctx context.Context, opts ...grpc.CallOption) (TaskService_LogStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &TaskService_ServiceDesc.Streams[3], "/cedana.services.task.TaskService/LogStreaming", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *taskServiceClient) ProcessStateStreaming(ctx context.Context, in *ProcessStateStreamingArgs, opts ...grpc.CallOption) (TaskService_ProcessStateStreamingClient, error) {
	stream, err := c.cc.NewStream(ctx, &TaskService_ServiceDesc.Streams[4], "/cedana.services.task.TaskService/ProcessStateStreaming", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *taskServiceClient) HostKataDump(ctx context.Context, in *HostDumpKataArgs, opts ...grpc.CallOption) (*HostDumpKataResp, error) {
	out := new(HostDumpKataResp)
	err := c.cc.Invoke(ctx, "/cedana.services.task.TaskService/HostKataDump", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaskServiceServer interface {
	...
	JobRestoreAttach(TaskService_JobRestoreAttachServer) error
...
func (UnimplementedTaskServiceServer) JobRestoreAttach(TaskService_JobRestoreAttachServer) error {
...
func _TaskService_JobDump_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cedana.services.task.TaskService/JobDump",
	}
...
func _TaskService_JobRestore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cedana.services.task.TaskService/JobRestore",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaskService_JobRestoreAttach_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TaskServiceServer).JobRestoreAttach(&taskServiceJobRestoreAttachServer{stream})
}

type TaskService_JobRestoreAttachServer interface {
	Send(*AttachResp) error
	Recv() (*AttachArgs, error)
	grpc.ServerStream
}

type taskServiceJobRestoreAttachServer struct {
	grpc.ServerStream
}

func (x *taskServiceJobRestoreAttachServer) Send(m *AttachResp) error {
	return x.ServerStream.SendMsg(m)
}

func (x *taskServiceJobRestoreAttachServer) Recv() (*AttachArgs, error) {
	m := new(AttachArgs)
...
func _TaskService_JobQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cedana.services.task.TaskService/JobQuery",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (x *taskServiceStartAttachServer) Send(m *AttachResp) error {
	return x.ServerStream.SendMsg(m)
}

func (x *taskServiceStartAttachServer) Recv() (*AttachArgs, error) {
	m := new(AttachArgs)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *taskServiceRestoreAttachServer) Send(m *AttachResp) error {
	return x.ServerStream.SendMsg(m)
}

func (x *taskServiceRestoreAttachServer) Recv() (*AttachArgs, error) {
	m := new(AttachArgs)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _TaskService_Manage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cedana.services.task.TaskService/Manage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaskService_RuncManage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cedana.services.task.TaskService/RuncManage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaskService_HostKataDump_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HostDumpKataArgs)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskServiceServer).HostKataDump(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cedana.services.task.TaskService/HostKataDump",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).HostKataDump(ctx, req.(*HostDumpKataArgs))
	}
	return interceptor(ctx, in, info, handler)
}
