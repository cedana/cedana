...
protoc --go_out=image --go_opt=paths=source_relative \
    ...
    --go_opt=Mimage.proto=github.com/cedana/cedana/pkg/api/services/image \
    --go-grpc_opt=Mimage.proto=github.com/cedana/cedana/pkg/api/services/image \
    -I$PROTO_DIR \
...
protoc --go_out=img_streamer --go_opt=paths=source_relative \
    ...
    --go_opt=Mimg_streamer.proto=github.com/cedana/cedana/pkg/api/services/img-streamer \
    --go-grpc_opt=Mimg_streamer.proto=github.com/cedana/cedana/pkg/api/services/img-streamer \
    -I$PROTO_DIR \
...
protoc --go_out=rpc --go_opt=paths=source_relative \
    ...
    --go_opt=Mrpc.proto=github.com/cedana/cedana/pkg/api/services/rpc \
    --go-grpc_opt=Mrpc.proto=github.com/cedana/cedana/pkg/api/services/rpc \
    -I$PROTO_DIR \
    $PROTO_DIR/rpc.proto
...
protoc --go_out=task --go_opt=paths=source_relative \
    ...
    --go_opt=Mgpu.proto=github.com/cedana/cedana/pkg/api/services/gpu \
    --go_opt=Mtask.proto=github.com/cedana/cedana/pkg/api/services/task \
    --go-grpc_opt=Mgpu.proto=github.com/cedana/cedana/pkg/api/services/gpu \
