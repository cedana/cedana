...
// UnimplementedCedanaGPUServer must be embedded to have
...
func (UnimplementedCedanaGPUServer) testEmbeddedByValue()                   {}
...
func RegisterCedanaGPUServer(s grpc.ServiceRegistrar, srv CedanaGPUServer) {
	// If the following call pancis, it indicates UnimplementedCedanaGPUServer was
