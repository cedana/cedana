...
const (
	...
	DEFAULT_GPU_STAGING_ENABLED   = true
	DEFAULT_GPU_STAGING_BUDGET_MB = 2048
	DEFAULT_GPU_STAGING_SLAB_MB   = 8
	DEFAULT_GPU_ASYNC_FLUSH       = false

	DEFAULT_CRIU_LEAVE_RUNNING  = false
	DEFAULT_CRIU_MANAGE_CGROUPS = "ignore"
	DEFAULT_CRIU_LOG_LEVEL      = 2
	DEFAULT_CRIU_PREDUMP_ROUNDS = 0
...
var Global Config = Config{
	...
	GPU: GPU{
		...
		StagingEnabled:   DEFAULT_GPU_STAGING_ENABLED,
		StagingBudgetMB:  DEFAULT_GPU_STAGING_BUDGET_MB,
		StagingSlabMB:    DEFAULT_GPU_STAGING_SLAB_MB,
		AsyncFlush:       DEFAULT_GPU_ASYNC_FLUSH,
	},
	CRIU: CRIU{
		LogLevel:      DEFAULT_CRIU_LOG_LEVEL,
		LeaveRunning:  DEFAULT_CRIU_LEAVE_RUNNING,
		ManageCgroups: DEFAULT_CRIU_MANAGE_CGROUPS,
		PredumpRounds: DEFAULT_CRIU_PREDUMP_ROUNDS,
	},
	Plugins: Plugins{
