...
type (
	...
	GPU struct {
		...
		// LibDir holds any additional directories to search for GPU libraries
		LdLibDir string `json:"lib_dir" key:"lib_dir" yaml:"lib_dir" mapstructure:"lib_dir" env_aliases:"CEDANA_GPU_LD_LIB_DIR"`
	}
