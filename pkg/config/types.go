...
type (
	...
	GPU struct {
		...
		// TraceMem toggles the incremental checkpointing optimization for CUDA memory
		TraceMem bool `json:"trace_mem" key:"trace_mem" yaml:"trace_mem" mapstructure:"trace_mem"`
	}
