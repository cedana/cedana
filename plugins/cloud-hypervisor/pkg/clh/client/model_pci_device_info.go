...
// checks if the PciDeviceInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PciDeviceInfo{}
...
type _PciDeviceInfo PciDeviceInfo
...
func (o PciDeviceInfo) ToMap() (map[string]interface{}, error) {
...
func (o *PciDeviceInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varPciDeviceInfo := _PciDeviceInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPciDeviceInfo)

	if err != nil {
		return err
	}

	*o = PciDeviceInfo(varPciDeviceInfo)
