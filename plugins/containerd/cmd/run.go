...
func init() {
	...
	RunCmd.Flags().StringP(containerd_flags.SnapshottterFlag.Full, containerd_flags.SnapshottterFlag.Short, "overlayfs", "snapshotter to use for containerd")
}
...
var RunCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		snapshotter, _ := cmd.Flags().GetString(containerd_flags.SnapshottterFlag.Full)
