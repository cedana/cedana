module github.com/cedana/cedana/plugins/k8s

go 1.25.1

replace github.com/cedana/cedana => ../..

replace github.com/cedana/cedana/plugins/containerd => ../containerd
...
require (
	buf.build/gen/go/cedana/cedana/grpc/go v1.5.1-20251009084235-3942f1f92d9c.2 // indirect
