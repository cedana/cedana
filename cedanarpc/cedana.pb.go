...
func (x *CheckpointRequest) GetJobID() int32 {
	if x != nil {
		return x.JobID
	}
	return 0
...
func (x *CheckpointRequest) GetWorkerID() int32 {
	if x != nil {
		return x.WorkerID
	}
	return 0
...
func (x *RestoreRequest) GetJobID() int32 {
	if x != nil {
		return x.JobID
	}
	return 0
...
func (x *RestoreRequest) GetWorkerID() int32 {
	if x != nil {
		return x.WorkerID
	}
	return 0
...
type OpenFilesStat struct {
	...
	Fd   string `protobuf:"bytes,2,opt,name=fd,proto3" json:"fd,omitempty"`
}
...
func (x *OpenFilesStat) GetFd() string {
	if x != nil {
		return x.Fd
	}
	return ""
...
type ClientInfo struct {
	...
	RemainingMemory string `protobuf:"bytes,6,opt,name=remainingMemory,proto3" json:"remainingMemory,omitempty"`
}
...
func (x *ClientInfo) GetUptime() string {
	if x != nil {
		return x.Uptime
	}
	return ""
...
func (x *ClientInfo) GetRemainingMemory() string {
	if x != nil {
...
func (x *StateResponse) GetJobID() int32 {
	if x != nil {
		return x.JobID
	}
	return 0
...
func (x *StateResponse) GetWorkerID() int32 {
	if x != nil {
		return x.WorkerID
	}
	return 0
...
var file_cedana_proto_rawDesc = []byte{
	...
	0x0a, 0x05, 0x6a, 0x6f, 0x62, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x6a,
	0x6f, 0x62, 0x49, 0x44, 0x12, 0x1a, 0x0a, 0x08, 0x77, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x49, 0x44,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x77, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x49, 0x44,
	...
	0x28, 0x05, 0x52, 0x05, 0x6a, 0x6f, 0x62, 0x49, 0x44, 0x12, 0x1a, 0x0a, 0x08, 0x77, 0x6f, 0x72,
	0x6b, 0x65, 0x72, 0x49, 0x44, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x77, 0x6f, 0x72,
	...
	0x68, 0x12, 0x0e, 0x0a, 0x02, 0x66, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x66,
	...
	0x09, 0x52, 0x06, 0x75, 0x70, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x28, 0x0a, 0x0f, 0x72, 0x65, 0x6d,
	0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0f, 0x72, 0x65, 0x6d, 0x61, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x4d, 0x65, 0x6d,
