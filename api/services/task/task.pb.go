...
var file_task_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xf5, 0x02, 0x0a, 0x18,
	...
	0x32, 0x0a, 0x04, 0x46, 0x6c, 0x61, 0x67, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e,
	...
	0x74, 0x61, 0x74, 0x65, 0x22, 0x32, 0x0a, 0x18, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x53, 0x74,
	...
	0x75, 0x73, 0x2a, 0x86, 0x01, 0x0a, 0x08, 0x46, 0x6c, 0x61, 0x67, 0x45, 0x6e, 0x75, 0x6d, 0x12,
	...
	0x08, 0x4a, 0x4f, 0x42, 0x5f, 0x44, 0x4f, 0x4e, 0x45, 0x10, 0x06, 0x32, 0xd3, 0x04, 0x0a, 0x0b,
	...
	0x7a, 0x0a, 0x14, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x53, 0x74,
	...
	0x69, 0x6e, 0x67, 0x52, 0x65, 0x73, 0x70, 0x1a, 0x2e, 0x2e, 0x63, 0x65, 0x64, 0x61, 0x6e, 0x61,
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x74, 0x61, 0x73, 0x6b, 0x2e, 0x43,
	0x6c, 0x69, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d,
	0x69, 0x6e, 0x67, 0x41, 0x72, 0x67, 0x73, 0x28, 0x01, 0x30, 0x01, 0x12, 0x74, 0x0a, 0x12, 0x4d,
...
var file_task_proto_goTypes = []interface{}{
	...
	(RestoreArgs_ProcessType)(0),               // 1: cedana.services.task.RestoreArgs.ProcessType
	(CheckpointReason_CheckpointReasonEnum)(0), // 2: cedana.services.task.CheckpointReason.CheckpointReasonEnum
	(*DumpArgs)(nil),                           // 3: cedana.services.task.DumpArgs
	(*DumpResp)(nil),                           // 4: cedana.services.task.DumpResp
	(*RestoreArgs)(nil),                        // 5: cedana.services.task.RestoreArgs
	(*RestoreResp)(nil),                        // 6: cedana.services.task.RestoreResp
	(*StartTaskArgs)(nil),                      // 7: cedana.services.task.StartTaskArgs
	(*StartTaskResp)(nil),                      // 8: cedana.services.task.StartTaskResp
	(*LogStreamingArgs)(nil),                   // 9: cedana.services.task.LogStreamingArgs
	(*LogStreamingResp)(nil),                   // 10: cedana.services.task.LogStreamingResp
	(*ClientStateStreamingArgs)(nil),           // 11: cedana.services.task.ClientStateStreamingArgs
	(*ClientInfo)(nil),                         // 12: cedana.services.task.ClientInfo
	(*ProcessInfo)(nil),                        // 13: cedana.services.task.ProcessInfo
	(*OpenFilesStat)(nil),                      // 14: cedana.services.task.OpenFilesStat
	(*ConnectionStat)(nil),                     // 15: cedana.services.task.ConnectionStat
	(*Addr)(nil),                               // 16: cedana.services.task.Addr
	(*CheckpointType)(nil),                     // 17: cedana.services.task.CheckpointType
	(*CheckpointState)(nil),                    // 18: cedana.services.task.CheckpointState
...
var file_task_proto_depIdxs = []int32{
	1,  // 0: cedana.services.task.RestoreArgs.Type:type_name -> cedana.services.task.RestoreArgs.ProcessType
	12, // 1: cedana.services.task.ClientStateStreamingArgs.ClientInfo:type_name -> cedana.services.task.ClientInfo
	13, // 2: cedana.services.task.ClientStateStreamingArgs.ProcessInfo:type_name -> cedana.services.task.ProcessInfo
	17, // 3: cedana.services.task.ClientStateStreamingArgs.CheckpointType:type_name -> cedana.services.task.CheckpointType
	0,  // 4: cedana.services.task.ClientStateStreamingArgs.Flag:type_name -> cedana.services.task.FlagEnum
	14, // 5: cedana.services.task.ProcessInfo.OpenFds:type_name -> cedana.services.task.OpenFilesStat
	15, // 6: cedana.services.task.ProcessInfo.OpenConnections:type_name -> cedana.services.task.ConnectionStat
	16, // 7: cedana.services.task.ConnectionStat.Laddr:type_name -> cedana.services.task.Addr
	16, // 8: cedana.services.task.ConnectionStat.Raddr:type_name -> cedana.services.task.Addr
	...
	2,  // 11: cedana.services.task.CheckpointReason.Reason:type_name -> cedana.services.task.CheckpointReason.CheckpointReasonEnum
	3,  // 12: cedana.services.task.TaskService.Dump:input_type -> cedana.services.task.DumpArgs
	5,  // 13: cedana.services.task.TaskService.Restore:input_type -> cedana.services.task.RestoreArgs
	7,  // 14: cedana.services.task.TaskService.StartTask:input_type -> cedana.services.task.StartTaskArgs
	10, // 15: cedana.services.task.TaskService.LogStreaming:input_type -> cedana.services.task.LogStreamingResp
	19, // 16: cedana.services.task.TaskService.ClientStateStreaming:input_type -> cedana.services.task.ClientStateStreamingResp
	20, // 17: cedana.services.task.TaskService.MetaStateStreaming:input_type -> cedana.services.task.MetaStateStreamingArgs
	4,  // 18: cedana.services.task.TaskService.Dump:output_type -> cedana.services.task.DumpResp
	6,  // 19: cedana.services.task.TaskService.Restore:output_type -> cedana.services.task.RestoreResp
	8,  // 20: cedana.services.task.TaskService.StartTask:output_type -> cedana.services.task.StartTaskResp
	9,  // 21: cedana.services.task.TaskService.LogStreaming:output_type -> cedana.services.task.LogStreamingArgs
	11, // 22: cedana.services.task.TaskService.ClientStateStreaming:output_type -> cedana.services.task.ClientStateStreamingArgs
	23, // 23: cedana.services.task.TaskService.MetaStateStreaming:output_type -> cedana.services.task.MetaStateStreamingResp
