...
var file_task_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x22, 0x72, 0x0a, 0x18, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x64,
	...
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x36, 0x0a, 0x18, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69,
	...
	0x4c, 0x45, 0x44, 0x10, 0x03, 0x32, 0xb7, 0x0a, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x65,
	...
	0x61, 0x6e, 0x61, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x74, 0x61, 0x73,
	0x6b, 0x2e, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x64, 0x52, 0x6f, 0x6f, 0x74,
	0x66, 0x73, 0x44, 0x75, 0x6d, 0x70, 0x52, 0x65, 0x73, 0x70, 0x12, 0x52, 0x0a, 0x08, 0x52, 0x75,
...
var file_task_proto_goTypes = []interface{}{
	...
	(*RuncDumpArgs)(nil),                       // 23: cedana.services.task.RuncDumpArgs
	(*RuncDumpResp)(nil),                       // 24: cedana.services.task.RuncDumpResp
	(*CriuOpts)(nil),                           // 25: cedana.services.task.CriuOpts
	(*RuncRestoreArgs)(nil),                    // 26: cedana.services.task.RuncRestoreArgs
	(*RuncRestoreResp)(nil),                    // 27: cedana.services.task.RuncRestoreResp
	(*RuncOpts)(nil),                           // 28: cedana.services.task.RuncOpts
	(*RuncQueryArgs)(nil),                      // 29: cedana.services.task.RuncQueryArgs
	(*RuncQueryResp)(nil),                      // 30: cedana.services.task.RuncQueryResp
	(*RuncContainer)(nil),                      // 31: cedana.services.task.RuncContainer
	(*RuncGetPausePidArgs)(nil),                // 32: cedana.services.task.RuncGetPausePidArgs
	(*RuncGetPausePidResp)(nil),                // 33: cedana.services.task.RuncGetPausePidResp
	(*LogStreamingArgs)(nil),                   // 34: cedana.services.task.LogStreamingArgs
	(*LogStreamingResp)(nil),                   // 35: cedana.services.task.LogStreamingResp
	(*ProcessState)(nil),                       // 36: cedana.services.task.ProcessState
	(*RemoteState)(nil),                        // 37: cedana.services.task.RemoteState
	(*ClientInfo)(nil),                         // 38: cedana.services.task.ClientInfo
	(*ProcessInfo)(nil),                        // 39: cedana.services.task.ProcessInfo
...
var file_task_proto_depIdxs = []int32{
	...
	36, // 2: cedana.services.task.QueryResp.Processes:type_name -> cedana.services.task.ProcessState
	20, // 3: cedana.services.task.ContainerdQueryResp.Containers:type_name -> cedana.services.task.ContainerdContainer
	25, // 4: cedana.services.task.RuncDumpArgs.CriuOpts:type_name -> cedana.services.task.CriuOpts
	0,  // 5: cedana.services.task.RuncDumpArgs.Type:type_name -> cedana.services.task.CRType
	28, // 6: cedana.services.task.RuncRestoreArgs.Opts:type_name -> cedana.services.task.RuncOpts
	0,  // 7: cedana.services.task.RuncRestoreArgs.Type:type_name -> cedana.services.task.CRType
	31, // 8: cedana.services.task.RuncQueryResp.Containers:type_name -> cedana.services.task.RuncContainer
	1,  // 9: cedana.services.task.ProcessState.ContainerRuntime:type_name -> cedana.services.task.ContainerRuntimeOpts
	39, // 10: cedana.services.task.ProcessState.ProcessInfo:type_name -> cedana.services.task.ProcessInfo
	...
	37, // 13: cedana.services.task.ProcessState.RemoteState:type_name -> cedana.services.task.RemoteState
	40, // 14: cedana.services.task.ProcessInfo.OpenFds:type_name -> cedana.services.task.OpenFilesStat
	41, // 15: cedana.services.task.ProcessInfo.OpenConnections:type_name -> cedana.services.task.ConnectionStat
	4,  // 16: cedana.services.task.OpenFilesStat.Stream:type_name -> cedana.services.task.OpenFilesStat.StreamType
	42, // 17: cedana.services.task.ConnectionStat.Laddr:type_name -> cedana.services.task.Addr
	42, // 18: cedana.services.task.ConnectionStat.Raddr:type_name -> cedana.services.task.Addr
	46, // 19: cedana.services.task.MetaStateStreamingArgs.Event:type_name -> cedana.services.task.ProviderEvent
	45, // 20: cedana.services.task.MetaStateStreamingArgs.CheckpointReason:type_name -> cedana.services.task.CheckpointReason
	...
	23, // 30: cedana.services.task.TaskService.RuncDump:input_type -> cedana.services.task.RuncDumpArgs
	26, // 31: cedana.services.task.TaskService.RuncRestore:input_type -> cedana.services.task.RuncRestoreArgs
	29, // 32: cedana.services.task.TaskService.RuncQuery:input_type -> cedana.services.task.RuncQueryArgs
	32, // 33: cedana.services.task.TaskService.RuncGetPausePid:input_type -> cedana.services.task.RuncGetPausePidArgs
	35, // 34: cedana.services.task.TaskService.LogStreaming:input_type -> cedana.services.task.LogStreamingResp
	43, // 35: cedana.services.task.TaskService.ProcessStateStreaming:input_type -> cedana.services.task.ProcessStateStreamingArgs
	7,  // 36: cedana.services.task.TaskService.Start:output_type -> cedana.services.task.StartResp
	9,  // 37: cedana.services.task.TaskService.Dump:output_type -> cedana.services.task.DumpResp
	11, // 38: cedana.services.task.TaskService.Restore:output_type -> cedana.services.task.RestoreResp
	13, // 39: cedana.services.task.TaskService.Query:output_type -> cedana.services.task.QueryResp
	15, // 40: cedana.services.task.TaskService.ContainerdDump:output_type -> cedana.services.task.ContainerdDumpResp
	17, // 41: cedana.services.task.TaskService.ContainerdRestore:output_type -> cedana.services.task.ContainerdRestoreResp
	19, // 42: cedana.services.task.TaskService.ContainerdQuery:output_type -> cedana.services.task.ContainerdQueryResp
	22, // 43: cedana.services.task.TaskService.ContainerdRootfsDump:output_type -> cedana.services.task.ContainerdRootfsDumpResp
	24, // 44: cedana.services.task.TaskService.RuncDump:output_type -> cedana.services.task.RuncDumpResp
	27, // 45: cedana.services.task.TaskService.RuncRestore:output_type -> cedana.services.task.RuncRestoreResp
	30, // 46: cedana.services.task.TaskService.RuncQuery:output_type -> cedana.services.task.RuncQueryResp
	33, // 47: cedana.services.task.TaskService.RuncGetPausePid:output_type -> cedana.services.task.RuncGetPausePidResp
	34, // 48: cedana.services.task.TaskService.LogStreaming:output_type -> cedana.services.task.LogStreamingArgs
	36, // 49: cedana.services.task.TaskService.ProcessStateStreaming:output_type -> cedana.services.task.ProcessState
