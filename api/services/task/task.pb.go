...
var file_task_proto_rawDesc = []byte{
	...
	0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x32, 0xc0, 0x0f, 0x0a, 0x0b, 0x54, 0x61,
	...
	0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x5e, 0x0a, 0x09,
...
var file_task_proto_msgTypes = make([]protoimpl.MessageInfo, 57)
var file_task_proto_goTypes = []interface{}{
	...
	(*DetailedHealthCheckRequest)(nil),         // 59: cedana.services.task.DetailedHealthCheckRequest
	(*DetailedHealthCheckResponse)(nil),        // 60: cedana.services.task.DetailedHealthCheckResponse
	(*HealthCheckStats)(nil),                   // 61: cedana.services.task.HealthCheckStats
	(*GetConfigRequest)(nil),                   // 62: cedana.services.task.GetConfigRequest
	(*GetConfigResponse)(nil),                  // 63: cedana.services.task.GetConfigResponse
	(*gpu.GPURestoreStats)(nil),                // 64: cedanagpu.GPURestoreStats
	(*gpu.HealthCheckResponse)(nil),            // 65: cedanagpu.HealthCheckResponse
}
var file_task_proto_depIdxs = []int32{
	...
	64, // 6: cedana.services.task.RestoreStats.GPURestoreStats:type_name -> cedanagpu.GPURestoreStats
	...
	61, // 39: cedana.services.task.DetailedHealthCheckResponse.HealthCheckStats:type_name -> cedana.services.task.HealthCheckStats
	65, // 40: cedana.services.task.HealthCheckStats.GPUHealthCheck:type_name -> cedanagpu.HealthCheckResponse
	14, // 41: cedana.services.task.TaskService.Start:input_type -> cedana.services.task.StartArgs
	16, // 42: cedana.services.task.TaskService.Dump:input_type -> cedana.services.task.DumpArgs
	18, // 43: cedana.services.task.TaskService.Restore:input_type -> cedana.services.task.RestoreArgs
	20, // 44: cedana.services.task.TaskService.Query:input_type -> cedana.services.task.QueryArgs
	22, // 45: cedana.services.task.TaskService.ContainerdDump:input_type -> cedana.services.task.ContainerdDumpArgs
	24, // 46: cedana.services.task.TaskService.ContainerdRestore:input_type -> cedana.services.task.ContainerdRestoreArgs
	26, // 47: cedana.services.task.TaskService.ContainerdQuery:input_type -> cedana.services.task.ContainerdQueryArgs
	29, // 48: cedana.services.task.TaskService.ContainerdRootfsDump:input_type -> cedana.services.task.ContainerdRootfsDumpArgs
	31, // 49: cedana.services.task.TaskService.ContainerdRootfsRestore:input_type -> cedana.services.task.ContainerdRootfsRestoreArgs
	33, // 50: cedana.services.task.TaskService.RuncDump:input_type -> cedana.services.task.RuncDumpArgs
	36, // 51: cedana.services.task.TaskService.RuncRestore:input_type -> cedana.services.task.RuncRestoreArgs
	39, // 52: cedana.services.task.TaskService.RuncQuery:input_type -> cedana.services.task.RuncQueryArgs
	42, // 53: cedana.services.task.TaskService.RuncGetPausePid:input_type -> cedana.services.task.RuncGetPausePidArgs
	12, // 54: cedana.services.task.TaskService.CRIORootfsDump:input_type -> cedana.services.task.CRIORootfsDumpArgs
	10, // 55: cedana.services.task.TaskService.CRIOImagePush:input_type -> cedana.services.task.CRIOImagePushArgs
	57, // 56: cedana.services.task.TaskService.StartAttach:input_type -> cedana.services.task.StartAttachArgs
	45, // 57: cedana.services.task.TaskService.LogStreaming:input_type -> cedana.services.task.LogStreamingResp
	55, // 58: cedana.services.task.TaskService.ProcessStateStreaming:input_type -> cedana.services.task.ProcessStateStreamingArgs
	59, // 59: cedana.services.task.TaskService.DetailedHealthCheck:input_type -> cedana.services.task.DetailedHealthCheckRequest
	62, // 60: cedana.services.task.TaskService.GetConfig:input_type -> cedana.services.task.GetConfigRequest
	15, // 61: cedana.services.task.TaskService.Start:output_type -> cedana.services.task.StartResp
	17, // 62: cedana.services.task.TaskService.Dump:output_type -> cedana.services.task.DumpResp
	19, // 63: cedana.services.task.TaskService.Restore:output_type -> cedana.services.task.RestoreResp
	21, // 64: cedana.services.task.TaskService.Query:output_type -> cedana.services.task.QueryResp
	23, // 65: cedana.services.task.TaskService.ContainerdDump:output_type -> cedana.services.task.ContainerdDumpResp
	25, // 66: cedana.services.task.TaskService.ContainerdRestore:output_type -> cedana.services.task.ContainerdRestoreResp
	27, // 67: cedana.services.task.TaskService.ContainerdQuery:output_type -> cedana.services.task.ContainerdQueryResp
	30, // 68: cedana.services.task.TaskService.ContainerdRootfsDump:output_type -> cedana.services.task.ContainerdRootfsDumpResp
	32, // 69: cedana.services.task.TaskService.ContainerdRootfsRestore:output_type -> cedana.services.task.ContainerdRootfsRestoreResp
	34, // 70: cedana.services.task.TaskService.RuncDump:output_type -> cedana.services.task.RuncDumpResp
	37, // 71: cedana.services.task.TaskService.RuncRestore:output_type -> cedana.services.task.RuncRestoreResp
	40, // 72: cedana.services.task.TaskService.RuncQuery:output_type -> cedana.services.task.RuncQueryResp
	43, // 73: cedana.services.task.TaskService.RuncGetPausePid:output_type -> cedana.services.task.RuncGetPausePidResp
	13, // 74: cedana.services.task.TaskService.CRIORootfsDump:output_type -> cedana.services.task.CRIORootfsDumpResp
	11, // 75: cedana.services.task.TaskService.CRIOImagePush:output_type -> cedana.services.task.CRIOImagePushResp
	58, // 76: cedana.services.task.TaskService.StartAttach:output_type -> cedana.services.task.StartAttachResp
	44, // 77: cedana.services.task.TaskService.LogStreaming:output_type -> cedana.services.task.LogStreamingArgs
	46, // 78: cedana.services.task.TaskService.ProcessStateStreaming:output_type -> cedana.services.task.ProcessState
	60, // 79: cedana.services.task.TaskService.DetailedHealthCheck:output_type -> cedana.services.task.DetailedHealthCheckResponse
	63, // 80: cedana.services.task.TaskService.GetConfig:output_type -> cedana.services.task.GetConfigResponse
