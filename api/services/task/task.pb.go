...
var file_task_proto_depIdxs = []int32{
	...
	59, // 38: cedana.services.task.DetailedHealthCheckResponse.HealthCheckStats:type_name -> cedana.services.task.HealthCheckStats
	63, // 39: cedana.services.task.HealthCheckStats.GPUHealthCheck:type_name -> cedanagpu.HealthCheckResponse
	14, // 40: cedana.services.task.TaskService.Start:input_type -> cedana.services.task.StartArgs
	16, // 41: cedana.services.task.TaskService.Dump:input_type -> cedana.services.task.DumpArgs
	18, // 42: cedana.services.task.TaskService.Restore:input_type -> cedana.services.task.RestoreArgs
	20, // 43: cedana.services.task.TaskService.Query:input_type -> cedana.services.task.QueryArgs
	22, // 44: cedana.services.task.TaskService.ContainerdDump:input_type -> cedana.services.task.ContainerdDumpArgs
	24, // 45: cedana.services.task.TaskService.ContainerdRestore:input_type -> cedana.services.task.ContainerdRestoreArgs
	26, // 46: cedana.services.task.TaskService.ContainerdQuery:input_type -> cedana.services.task.ContainerdQueryArgs
	29, // 47: cedana.services.task.TaskService.ContainerdRootfsDump:input_type -> cedana.services.task.ContainerdRootfsDumpArgs
	31, // 48: cedana.services.task.TaskService.ContainerdRootfsRestore:input_type -> cedana.services.task.ContainerdRootfsRestoreArgs
	33, // 49: cedana.services.task.TaskService.RuncDump:input_type -> cedana.services.task.RuncDumpArgs
	36, // 50: cedana.services.task.TaskService.RuncRestore:input_type -> cedana.services.task.RuncRestoreArgs
	39, // 51: cedana.services.task.TaskService.RuncQuery:input_type -> cedana.services.task.RuncQueryArgs
	42, // 52: cedana.services.task.TaskService.RuncGetPausePid:input_type -> cedana.services.task.RuncGetPausePidArgs
	12, // 53: cedana.services.task.TaskService.CRIORootfsDump:input_type -> cedana.services.task.CRIORootfsDumpArgs
	10, // 54: cedana.services.task.TaskService.CRIOImagePush:input_type -> cedana.services.task.CRIOImagePushArgs
	45, // 55: cedana.services.task.TaskService.LogStreaming:input_type -> cedana.services.task.LogStreamingResp
	55, // 56: cedana.services.task.TaskService.ProcessStateStreaming:input_type -> cedana.services.task.ProcessStateStreamingArgs
	57, // 57: cedana.services.task.TaskService.DetailedHealthCheck:input_type -> cedana.services.task.DetailedHealthCheckRequest
	60, // 58: cedana.services.task.TaskService.GetConfig:input_type -> cedana.services.task.GetConfigRequest
	15, // 59: cedana.services.task.TaskService.Start:output_type -> cedana.services.task.StartResp
	17, // 60: cedana.services.task.TaskService.Dump:output_type -> cedana.services.task.DumpResp
	19, // 61: cedana.services.task.TaskService.Restore:output_type -> cedana.services.task.RestoreResp
	21, // 62: cedana.services.task.TaskService.Query:output_type -> cedana.services.task.QueryResp
	23, // 63: cedana.services.task.TaskService.ContainerdDump:output_type -> cedana.services.task.ContainerdDumpResp
	25, // 64: cedana.services.task.TaskService.ContainerdRestore:output_type -> cedana.services.task.ContainerdRestoreResp
	27, // 65: cedana.services.task.TaskService.ContainerdQuery:output_type -> cedana.services.task.ContainerdQueryResp
	30, // 66: cedana.services.task.TaskService.ContainerdRootfsDump:output_type -> cedana.services.task.ContainerdRootfsDumpResp
	32, // 67: cedana.services.task.TaskService.ContainerdRootfsRestore:output_type -> cedana.services.task.ContainerdRootfsRestoreResp
	34, // 68: cedana.services.task.TaskService.RuncDump:output_type -> cedana.services.task.RuncDumpResp
	37, // 69: cedana.services.task.TaskService.RuncRestore:output_type -> cedana.services.task.RuncRestoreResp
	40, // 70: cedana.services.task.TaskService.RuncQuery:output_type -> cedana.services.task.RuncQueryResp
	43, // 71: cedana.services.task.TaskService.RuncGetPausePid:output_type -> cedana.services.task.RuncGetPausePidResp
	13, // 72: cedana.services.task.TaskService.CRIORootfsDump:output_type -> cedana.services.task.CRIORootfsDumpResp
	11, // 73: cedana.services.task.TaskService.CRIOImagePush:output_type -> cedana.services.task.CRIOImagePushResp
	44, // 74: cedana.services.task.TaskService.LogStreaming:output_type -> cedana.services.task.LogStreamingArgs
	46, // 75: cedana.services.task.TaskService.ProcessStateStreaming:output_type -> cedana.services.task.ProcessState
	58, // 76: cedana.services.task.TaskService.DetailedHealthCheck:output_type -> cedana.services.task.DetailedHealthCheckResponse
	61, // 77: cedana.services.task.TaskService.GetConfig:output_type -> cedana.services.task.GetConfigResponse
